...
export const NEWS_CARDS: NewsCard[] = [
    {
        ...
        body: "49/49 E2E tests. OTP chain proofs, offToken isolation, pre-image resistant chain. Factory + Impl MIT-verified on Etherscan.",
        link: { text: "View full record", href: "/qryptum-sepolia-verified-v6" },
    },
    {
        ...
        body: "32/32 E2E tests. bytes32 proofHash, unshieldToRailgun, QryptAir EIP-712. Superseded by v6 (OTP chain + offToken upgrade).",
        link: { text: "View full record", href: "/qryptum-sepolia-verified-v5" },
        decommissioned: true,
    },
    {
        ...
        body: "v4 added QryptAir EIP-712 offTokens and QryptShield Railgun integration. Superseded by v5 (bytes32 proofHash upgrade).",
        link: { text: "View full record", href: "/qryptum-sepolia-verified-v4" },
        decommissioned: true,
    },
    {
        ...
        link: { text: "View full record", href: "/qryptum-sepolia-verified-v3" },
        decommissioned: true,
    },
    {
        ...
        link: { text: "View full record", href: "/qryptum-sepolia-verified-v2" },
        decommissioned: true,
    },
    {
        ...
        link: { text: "View full record", href: "/qryptum-sepolia-verified-v1" },
        decommissioned: true,
    },
];
