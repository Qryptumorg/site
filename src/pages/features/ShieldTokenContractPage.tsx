...
export default function ShieldTokenContractPage() {
    return (
        <FeatureBentoPage
            ...
            heroSubtitle="ShieldToken is an ERC-20 contract where transfer() and transferFrom() permanently revert. Movement is only possible through the PersonalQRYPTANK contract using a valid vault proof."
            primaryColor="#EC4899"
            ...
            stats={[
                ...
                { value: "QRYPTANK only", label: "Movement path", note: "Via vault proof only" },
            ]}
            sectionBadge="CONTRACT DESIGN"
            sectionHeading="Why qTokens Cannot Be Transferred Directly"
            sectionBody="ShieldToken overrides the standard ERC-20 transfer() and transferFrom() to permanently revert. This is a bytecode-level restriction: it cannot be bypassed by any UI or external contract. Movement requires a vault proof submitted through PersonalQRYPTANK."
            sectionColor="#EC4899"
            cards={[
                {
                    ...
                    body: "ShieldToken overrides ERC-20 transfer() to always revert with 'use QRYPTANK'. No wallet-to-wallet send is possible through any path.",
                ...
                },
                {
                    ...
                    color: "#8B5CF6",
                    title: "Only QRYPTANK Can Move Tokens",
                    body: "The ShieldToken contract whitelists the associated PersonalQRYPTANK address. Only calls from this address are permitted to call the internal _transfer function.",
                },
                {
                    img: "https://images.unsplash.com/photo-1639762681057-408e52192e55?w=800&auto=format",
                    color: "#DB2777",
                    title: "Mint and Burn Interface",
                    body: "PersonalQRYPTANK calls mint() on shield and burnFrom() on unshield. Both functions are restricted to the whitelisted QRYPTANK address.",
            ...
            techNote={{
                ...
                lines: [
                    ...
                    "        revert('use QRYPTANK to transfer');",
                    "    }",
