...
export default function GettingShieldedPage() {
    return (
        <FeatureBentoPage
            ...
            heroSubtitle="From a fresh wallet to a fully operational QRYPTANK with shielded tokens in under 5 minutes. No technical knowledge required."
            primaryColor="#06b6d4"
            ...
            cards={[
                {
                    ...
                    body: "Use MetaMask or any WalletConnect-compatible wallet. Your wallet address becomes the permanent owner of your QRYPTANK. No account creation required.",
                    link: { text: "Supported wallets", href: "/docs/introduction/overview" },
                },
                {
                    img: "/images/getting-deploy.png",
                    color: "#7c3aed",
                    title: "Deploy Your QRYPTANK",
                ...
                },
                {
                    ...
                    body: "Once shielded, your assets are protected by dual-factor security. No one, including Qryptum, can access them. Your QRYPTANK is permanent on Ethereum L1.",
            ...
            steps={[
                ...
                { n: "02", color: "#7c3aed", title: "Deploy QRYPTANK", desc: "Choose your 6-character vault proof (3 lowercase letters + 3 digits). Submit the deployment transaction.", detail: "ShieldFactory.deployVault(passwordHash): gas: ~150,000 units." },
                { n: "03", color: "#10b981", title: "Approve Token", desc: "Select the ERC-20 you want to shield. Click Approve to allow your QRYPTANK to pull funds.", detail: "token.approve(vaultAddress, amount): standard ERC-20 approval." },
