...
export default function PersonalQryptankContractPage() {
    return (
        <FeatureBentoPage
            pageTitle="PersonalQRYPTANK"
            badge="SMART CONTRACTS"
            heroTitle="Your Vault"
            heroHighlight="Contract on L1"
            heroSubtitle="PersonalQRYPTANK is the core contract that holds your shielded assets. It exposes shield(), transfer(), and unshield() functions: each requiring vault proof verification on every call."
            primaryColor="#7C3AED"
            ...
            cards={[
                {
                    ...
                    body: "Deposits an ERC-20 token into the QRYPTANK and mints the equivalent qToken to the caller. Requires a valid vault proof hash match.",
            ...
            techNote={{
                label: "Contract: PersonalQRYPTANK interface",
                lines: [
                    "interface IPersonalQRYPTANK {",
